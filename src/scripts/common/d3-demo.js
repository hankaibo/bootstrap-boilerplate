...
(function () {
  ...
  var force = d3.forceSimulation()
    ...
    .force('velocityDecay', function () { return 0.95; })
...
(function () {
  var w = 1280;
  var h = 800;
  var forceX = d3.forceX(function (d) { return w }).strength(0);

  //strong y positioning based on row
  var forceY = d3.forceY(function (d) { return h }).strength(0);
  ...
  var force = d3.forceSimulation()
    ...
    .force('charge', d3.forceManyBody().strength(0))
    .force('velocityDecay', function () { return 0.7; });
...
(function () {
  ...
  function update() {
    ...
    force.nodes(nodes)
      ...
      // .linkDistance(100)
      .force('velocityDecay', function () { return 0.5; })
      // .linkStrength(function (l, i) { return 1; })
      .force("link", d3.forceLink().id(function (d) { return d.id; }))
      .force('x', d3.forceX(function (d) { return h }).strength(0.05))
      .force('y', d3.forceY(function (d) { return h }).strength(0.05))
      .on("tick", tick)
      .restart();
