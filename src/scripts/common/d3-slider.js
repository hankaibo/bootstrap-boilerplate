/**
 * This is a pure D3.js slider.
 * It's source is https://github.com/MasterMaps/d3-slider.git.
 * @author hankaibo
 * @returns
 */
  ...
  function slider(selection) {
    selection.each(function () {
      ...
      function createAxis(dom) {
        ...
        axisScale = scale.ticks ? scale.copy().range([0, sliderLength]) : scale.copy().range([0, sliderLength]);
